define(["knockout","https://unpkg.com/react@16.5.2/umd/react.production.min","https://unpkg.com/react-dom@16.5.2/umd/react-dom.production.min"], function(__WEBPACK_EXTERNAL_MODULE_knockout__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_dom__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
  ...
  //
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! knockout */ "knockout")], __WEBPACK_AMD_DEFINE_RESULT__ = (function def(ko) {
    var App;
    return {
      inited: false,
      onLoad: function onLoad(model) {
        App = _react2.default.createElement(_App2.default, null);
      },
      beforeAppear: function beforeAppear(model) {},
      onRender: function onRender() {
        console.log(this, ko, document.getElementById('occReactComponent'));

        _reactDom2.default.render(App, document.getElementById('occReactComponent'));
      }
    };
  }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
